...
% This code generates the stochastic time series to calculate a stochastic
% potential 
...
fileID1=fopen('concentration_trajectory_forward_188_6.out','w');
...
while n<n_max
      n = n + 1;
      t=0; S=188000;
      m=900*rand(1);mu=1400+22000*rand(1); Z=3000+800000*rand(1);
%       disp([n,m,mu,Z]);
      disp(n);
    while t < t_max
